...
public class ReviewsController {
    ...
    private void loadMockReviews()
    {
        ...
        reviews.add(new Review(1, 1, "Very Bad Developer, Won't Recommend!", false, 1,
                now, now, false, 1));
        reviews.add(new Review(2, 5, "Whom are you calling bad!!", true, 1,
                Timestamp.valueOf(now.toLocalDateTime().plusDays(1)), now, false, 1));
        reviews.add(new Review(3, 4, "huh!", true, 1,
                now, now, false, 1));
        reviews.add(new Review(4, 1, "Plz avoid this fraud!", false, 1,
                now, now, false, 1));
    }
}
